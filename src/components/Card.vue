<template>
    <svg style="cursor: pointer" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" height="360" width="235">
    <defs>
    ...
    <rect v-if="selected" x="5" y="5" height="350" width="225" rx="10" ry="10" fill="white" stroke="yellow" stroke-width="14"></rect>
